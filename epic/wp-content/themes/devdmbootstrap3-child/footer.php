<footer>
	...
	<div class="row dmbs-footer">
		...
		<div class="container">
			...
			<div class="col-md-8 footer-copy">EPIC is a 501(c)(3) incorporated in the state of Oregon. EPIC works in partnership with the American Anthropological Association (AAA) through the sub-section of the National Association of Practicing Anthropologists (NAPA).
				<br/><br/>&copy; Epic 2014&nbsp;&nbsp;&nbsp;&nbsp;<a href="http://epiconference.com/">About</a>&nbsp;&nbsp;&nbsp;&nbsp;<a href="http://epiconference.com/contact">Contact</a>
				...
				if ($dm_settings['author_credits'] != 0) : ?>
					...
					<div class="col-md-4 footer-copy">
						Stay Connected!
						<a href="https://twitter.com/epiconference" class="social-icons-placement"><img src="http://epiconference.com/2014/wp-content/themes/devdmbootstrap3-child/img/twitter.png"></a>
