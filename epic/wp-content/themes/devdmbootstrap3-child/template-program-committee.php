...
<div class="white-background-two">
    <div class="container">
        ...
        <div class="row committee-placement">
            ...
            <div class="col-sm-3"><img src="<?php the_field('headshot_2'); ?>" class="headshot-size"/>             
                <div class="headshot-info"><?php the_field('headshot_info_2'); ?></div>
            </div><!--col-->
            <div class="col-sm-3"><img src="<?php the_field('headshot_3'); ?>" class="headshot-size"/>          
                <div class="headshot-info"><?php the_field('headshot_info_3'); ?></div>
            </div><!--col-->
            <div class="col-sm-3"><img src="<?php the_field('headshot_4'); ?>" class="headshot-size"/>          
        ...
        <div class="row committee-placement">
            ...
            <div class="col-sm-3"><img src="<?php the_field('headshot_6'); ?>" class="headshot-size"/>             
                <div class="headshot-info"><?php the_field('headshot_info_6'); ?></div>
            </div><!--col-->
            <div class="col-sm-3"><img src="<?php the_field('headshot_7'); ?>" class="headshot-size"/>          
                <div class="headshot-info"><?php the_field('headshot_info_7'); ?></div>
            </div><!--col-->
            <div class="col-sm-3"><img src="<?php the_field('headshot_8'); ?>" class="headshot-size"/>          
        ...
        <div class="row">
            ...
            <?php the_field('horizontal_rule_2'); ?>
        </div><!--row-->
        ...
        <div class="row committee-placement">
            ...
            <div class="col-sm-3"><img src="<?php the_field('headshot_19'); ?>" class="headshot-size"/>          
                <div class="headshot-info"><?php the_field('headshot_info_19'); ?></div>
            </div><!--col-->
            <div class="col-sm-3"><img src="<?php the_field('headshot_20'); ?>" class="headshot-size"/>          
        ...
        <!-- Row 6 Headshots Start -->

        <div class="row committee-placement">
            <div class="col-md-6 box-header">           
                <h3><?php the_field('box_header_6'); ?></h3>
            </div><!--col-->
        </div><!--row-->
        <div class="row committee-placement">
            ...
            <div class="col-sm-3"><img src="<?php the_field('headshot_22'); ?>" class="headshot-size"/>             
                <div class="headshot-info"><?php the_field('headshot_info_22'); ?></div>
            </div><!--col-->
            <div class="col-sm-3"><img src="<?php the_field('headshot_23'); ?>" class="headshot-size"/>          
                <div class="headshot-info"><?php the_field('headshot_info_23'); ?></div>
            </div><!--col-->
            <div class="col-sm-3"><img src="<?php the_field('headshot_24'); ?>" class="headshot-size"/>          
        ...
        <!-- Row 7 Headshots Start -->

        <div class="row committee-placement">
            <div class="col-md-6 box-header">           
                <h3><?php the_field('box_header_7'); ?></h3>
            </div><!--col-->
        </div><!--row-->
        <div class="row committee-placement">
        ...
        <!-- Row 8 Headshots Start -->

        <div class="row committee-placement">
            <div class="col-md-6 box-header">           
                <h3><?php the_field('box_header_8'); ?></h3>
            </div><!--col-->
        </div><!--row-->
        <div class="row committee-placement">
            <div class="col-sm-3"><img src="<?php the_field('headshot_29'); ?>" class="headshot-size"/>        
                <div class="headshot-info"><?php the_field('headshot_info_29'); ?></div>
            </div><!--col-->
            <div class="col-sm-3"><img src="<?php the_field('headshot_30'); ?>" class="headshot-size"/>             
                <div class="headshot-info"><?php the_field('headshot_info_30'); ?></div>
            </div><!--col-->
            <div class="col-sm-3"><img src="<?php the_field('headshot_31'); ?>" class="headshot-size"/>          
                <div class="headshot-info"><?php the_field('headshot_info_31'); ?></div>
            </div><!--col-->
            <div class="col-sm-3"><img src="<?php the_field('headshot_32'); ?>" class="headshot-size"/>          
                <div class="headshot-info"><?php the_field('headshot_info_32'); ?></div>
            </div><!--col-->

        <div class="row">
            <!--<div class="col-md-12 horiz-line">           
            </div>--><!--col-->
            <?php the_field('horizontal_rule_8'); ?>
        </div><!--row-->
